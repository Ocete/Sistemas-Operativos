...
int main(int argc, char *argv[]) {
	...
	//Abrimos los archivos, creándolos si no existen con los permisos dados
	...
	//Cambiamos la máscara de creación de archivos del proceso
	//actual a 777 ( = valor_introducido & 0777)
	umask(0);
	...
	//CAMBIO DE PERMISOS
	//Leemos los detalles del fichero "archivo1" que nos harán falta para su cambio de permisos
	...
	//A continuación utilizamos chmod para cambiar los permisos de los archivos 1 y 2
